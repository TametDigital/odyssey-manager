(function () {
  ...
  var css = [
    ...
    '.om-footer-card-title{font-size:.9375rem;font-weight:700;color:#2C2E4D;line-height:1.2;margin-top:2px;}',
    '.om-footer-card-text{font-size:.8125rem;font-weight:500;color:rgba(44,46,77,.65);line-height:1.45;flex:1;}',
      ...
      '<div class="om-footer-main">',
        ...
        '<div class="om-footer-card" style="width:220px">',
          '<div class="om-footer-card-img">',
            '<img src="images/hero_lourdes.jpg" alt="Sanctuaire de Lourdes" style="object-position:center center">',
          '</div>',
          '<div class="om-footer-card-label">&Eacute;tude de cas</div>',
          '<div class="om-footer-card-title">Sanctuaire de Lourdes</div>',
          '<div class="om-footer-card-text">Int&eacute;gration en marque blanche de 85&nbsp;% des h&eacute;bergements de la ville</div>',
        ...
        '<div class="om-footer-card" style="width:220px">',
          '<div class="om-footer-card-img">',
            '<img src="images/hero_dododog.jpg" alt="DodoDog" style="object-position:center top">',
          '</div>',
          '<div class="om-footer-card-label">&Eacute;tude de cas</div>',
          '<div class="om-footer-card-title">DodoDog</div>',
          '<div class="om-footer-card-text">La plateforme d&eacute;di&eacute;e au voyage canin en France</div>',
          '<a href="etude-de-cas-dododog.html" class="om-footer-card-btn">',
            svg('<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="1"/>',15),
            'D&eacute;couvrir',
          '</a>',
        '</div>',
